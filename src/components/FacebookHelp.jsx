...
const FacebookHelp = ({ currentUser, authToken, notice, warning }) => {
  return (
    <FacebookLayout
        ...
        <section>
          <article>
            <p className="intro-paragraph">
              The 
              {' '}
              <abbr title="Williams Students Online">WSO</abbr>
              {' '}
Facebook
              ...
              {' '}
              <abbr title="Office for Information Technology">OIT</abbr>
              {' '}
(Unix
              ID) username and password. Please report any strange behavior
              (after looking over the info below) to
              <code>wso-dev</code> 
              {' '}
              <code>[at]</code>
              {' '}
              <code>wso.williams.edu</code>
. The more descriptive your bug
              reports are, the easier the bug is to fix. Better yet, come to a
              meeting (join the
              {' '}
              <a
            ...
            <table className="inline">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {' '}
                    (intersection) all people who match 
                    {' '}
                    <strong>
                      both
                    </strong>
...
all people whose names match
            ...
            <p>
              Parentheses can be nested to any depth. Labels cannot be nested.
              It doesn&rsquo;t make sense to search only within the dorm field
              when already searching only within the name field, for example.
            </p>
            <br />

            <h3>Search tutorial</h3>
            <p>
              To search for people in the Facebook, you can enter search terms
              to be matched in any part of their profiles. For example,
              searching for 
              {' '}
              <code>Williams</code>
              {' '}
yields everyone who lives in
              Williams Hall, all students from Williamstown (or any other town
              with &ldquo;Williams&rdquo; in its name), anyone with
            ...
            <p>
              Single-word searches are pretty boring and often yield more
              results than you want. You can combine multiple search terms to
              create more powerful queries. The simplest way to do this is to
              separate search terms by space as you would in an internet search.
              For example, to search for the Ephraim Williams (as there are so
              many of them) who lives in Dodd, we would use the query
            </p>
            ...
            <p>
              ...
              Alas, searching for 
              {' '}
              <code>frosh quad</code>
              {' '}
won&rsquo;t do it, but
              neither will 
              {' '}
              <code>Williams Sage</code>
              {' '}
or
              {' '}
              <code>Williams &amp; Sage</code>
. What we want is
            ...
            <pre className="code">Williams | Sage</pre>
            <p>
              These will both yield all people who match &ldquo;Williams&rdquo;
              or &ldquo;Sage&rdquo;, or in other words, everyone who matches
              &ldquo;Williams&rdquo; plus everyone who matches
              &ldquo;Sage.&rdquo;
            </p>
            <p>
            ...
            <p>
              ...
              it&rsquo;s not often an issue, but in some cases we just
              don&rsquo;t want as results everyone matching &ldquo;Mark&rdquo;
              and &ldquo;Hopkins,&rdquo; but rather &ldquo;Mark Hopkins&rdquo;
              literally. In those cases you can use what probably seems the
              obvious approach: quotes. A search for
              {' '}
              <code>&ldquo;Mark Hopkins&rdquo;</code>
              {' '}
does the trick.
            </p>
            <br />
            ...
            <h4>Labels</h4>
            <p>
              Another shortcoming of matching each search term against any part
              of a person&rsquo;s profile is that some searches, like finding
              someone named William who lives in... Williams Hall, are pretty
              much impossible. Luckily, we have labels to help narrow a search.
              For our hypothetical William of Williams Hall, we would use the
              following query:
            </p>
...
style email
            ...
            <h4>Parentheses</h4>
            <p>
              With the tools we have thus far, there are still some searches
              which would be difficult or annoying to do. For example, try to
              find all the people named Ephraim who live in the former freshman
              dorms that are now upperclass dorms (East, Fayerweather, Morgan,
              Lehman). Since the AND operators take precedence over the OR
              operators, we would have to type:
            </p>
            <pre className="code">
            ...
            <p>
              ...
              inclusion of parentheses, we&rsquo;ve also made use of the fact
              that a label applied to a parenthesized subquery is applied to
              each of the terms inside that query. This is very handy, since it
              requires writing the label just once... In addition, you can nest
              parentheses as many times as you&rsquo;d like and put spaces
              between parentheses and their contained search terms:
              {' '}
            </p>
            <pre className="code">
...
Facebook
                ...
                &ldquo;the Facebook&rdquo; since its inception. To distinguish
                it from Facebook.com, which is commonly referred to as
...
Facebook as
                ...
                <abbr title="Williams Students Online">WSO</abbr>
                {' '}
                Facebook,&rdquo; or &ldquo;the Facebook,&rdquo; for short.
              </div>
            </div>
          </article>
        </section>
...
FacebookHelp.propTypes = {
  currentUser: PropTypes.object.isRequired,
  authToken: PropTypes.string.isRequired,
  notice: PropTypes.string,
  warning: PropTypes.string,
};
FacebookHelp.defaultProps = {
  notice: '',
  warning: '',
};
