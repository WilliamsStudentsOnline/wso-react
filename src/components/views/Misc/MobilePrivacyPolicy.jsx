    ...
    <div className="article">
      <section>
        <article>
          <br />
          <br />
          <h1>Williams Mobile Privacy Policy</h1>
          <br />
          <br />
          <p>
            Aidan Lloyd-Tucker built the Williams Mobile app as a Free app. This
            SERVICE is provided by Aidan Lloyd-Tucker at no cost and is intended
            for use as is.
          </p>{" "}
          <p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Williams Mobile
          ...
          <p>
            ...
            including but not limited to user ID, profile photo. The information
          ...
          <p>This policy is effective as of 2021-02-11</p>{" "}
          <p>
            <strong>Contact Us</strong>
          </p>{" "}
          <p>
            If you have any questions or suggestions about my Privacy Policy, do
            not hesitate to contact me at wso-dev+app@wso.williams.edu.
          </p>
        </article>
      </section>
    </div>
