...
const About = ({ notice, warning, currentUser }) => {
  return (
    <Layout
      bodyClass="front"
      notice={notice}
    ...
    >
      <div className="article">
        <div className="about-banner">
          <img src="/assets/banners/Doughty.png" alt="Doughty Banner" />
        ...
        <section className="about-section">
          <article>
            ...
            <h3>Services</h3>
            <p>
              WSO provides a number of services to the Williams College
              community free of charge. The use of these services is governed by
              this policy.
            </p>
            ...
            <p>
              ...
              decisions regarding visibility of services. That being said,
              aspects of many of these services are available to the general
              public. WSO reserves the right to further restrict all use of WSO
              services to members of the Williams College community should the
              need arise due to limited resources, etc., though this is a highly
              unlikely situation.
            </p>
            ...
            <p>
              ...
              for the site, please contact wso-staff [at] wso.williams.edu
